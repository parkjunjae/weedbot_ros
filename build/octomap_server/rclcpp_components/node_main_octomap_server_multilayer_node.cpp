...
#define NODE_MAIN_LOGGER_NAME "octomap_server_multilayer_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liboctomap_server_multilayer.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<octomap_server::OctomapServerMultilayer>";
