...
#define NODE_MAIN_LOGGER_NAME "tracking_octomap_server_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtracking_octomap_server.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<octomap_server::TrackingOctomapServer>";
