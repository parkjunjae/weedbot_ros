...
#define NODE_MAIN_LOGGER_NAME "octomap_server_static_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liboctomap_server_static.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<octomap_server::OctomapServerStatic>";
