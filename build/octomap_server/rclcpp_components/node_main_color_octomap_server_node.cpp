...
#define NODE_MAIN_LOGGER_NAME "color_octomap_server_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcolor_octomap_server.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<octomap_server::ColorOctomapServer>";
